...
db.addUser(new User(2, 'Shawna Bunch', 30, 'October 2016', 1, 'It is a blessing to spend time with my family.', true, 2, 'San Francisco, CA', 'bs-photo.png', ['Hi! I got your story today.', 'Oh hi! I cannot believe it... Someone received my story!', 'I learned the great pain that you are suffering from. It\'s tough'], 'Shawna lives in your neighborhood. She was diagnosed around the same time as you.'));
...
db.addUser(new User(3, 'Samantha Stephenson', 30, 'November 2016', 2, 'Cancer has taught me the different languages of love; that each person “speaks” their love differently.', true, 1, 'Oakland, CA', 'ss-photo.png', ['Hi Samantha! I got your story today.', 'Hi Julie!', 'Nice to talk to you!'],'Samantha lives in your neighborhood. She is a mother and also has stage 2 breast cancer.'));
