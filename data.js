...
db.addUser(new User(1, 'Audrey Allen', 39, 'November, 2016', 2, 'My life is all about my family.', true, 1, 'San Francisco, CA', 'aa-photo.png', [],'Audrey lives in your neighborhood. She is a mother and cares about her family alot.'));
...
db.addUser(new User(2, 'Shawna Bunch', 30, 'October 2016', 1, 'It is a blessing to spend time with my family.', true, 2, 'San Francisco, CA', 'bs-photo.png', ['filler message and good stuff', 'filler message and good stuff', 'filler message and good stuff'], 'Samantha lives in your neighborhood. She is a mother and cares about her family alot.'));
...
db.addUser(new User(3, 'Samantha Stephenson', 30, 'November 2016', 2, 'This is my bio yo', true, 1, 'Oakland, CA', 'ss-photo.png', ['filler message and good stuff', 'filler message and good stuff', 'Say what!?'],'Cancer has taught me the different languages of love; that each person “speaks” their love differently.'));
